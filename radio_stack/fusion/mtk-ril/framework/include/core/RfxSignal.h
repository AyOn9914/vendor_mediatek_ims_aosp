...
public:
    ...
    // trigger this signal for specific RfxObject
    void emit(RfxObject *obj) const {
        if (!m_slot_list.isEmpty()) {
            RfxSlotList tmpSlotList(m_slot_list);
            emitSlots(&tmpSlotList, (RfxEmitEntryFuncPtr)&RfxSignal0::emitEntry, NULL, obj);
        }
    }
...
public:
    ...
    // trigger this signal for specific RfxObject
    void emit(_arg1_type arg1, RfxObject *obj) const {
        if (!m_slot_list.isEmpty()) {
            Argument arg(arg1);
            RfxSlotList tmpSlotList(m_slot_list);
            emitSlots(&tmpSlotList, (RfxEmitEntryFuncPtr)&RfxSignal1::emitEntry, (void*)&arg, obj);
        }
    }
...
public:
    ...
    // trigger this signal for specific RfxObject
    void emit(_arg1_type arg1, _arg2_type arg2, RfxObject *obj) const {
        if (!m_slot_list.isEmpty()) {
            Argument arg(arg1, arg2);
            RfxSlotList tmpSlotList(m_slot_list);
            emitSlots(&tmpSlotList, (RfxEmitEntryFuncPtr)&RfxSignal2::emitEntry, (void*)&arg, obj);
        }
    }
...
public:
    ...
    // trigger this signal for specific RfxObject
    void emit(_arg1_type arg1, _arg2_type arg2, _arg3_type arg3, RfxObject *obj) const {
        if (!m_slot_list.isEmpty()) {
            Argument arg(arg1, arg2, arg3);
            RfxSlotList tmpSlotList(m_slot_list);
            emitSlots(&tmpSlotList, (RfxEmitEntryFuncPtr)&RfxSignal3::emitEntry, (void*)&arg, obj);
        }
    }
...
public:
    ...
    // trigger this signal for specific RfxObject
    void emit(_arg1_type arg1, _arg2_type arg2, _arg3_type arg3, _arg4_type arg4,
        RfxObject *obj) const {
        if (!m_slot_list.isEmpty()) {
            Argument arg(arg1, arg2, arg3, arg4);
            RfxSlotList tmpSlotList(m_slot_list);
            emitSlots(&tmpSlotList, (RfxEmitEntryFuncPtr)&RfxSignal4::emitEntry, (void*)&arg, obj);
        }
    }
