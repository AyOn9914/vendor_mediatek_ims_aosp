...
#ifndef __RFX_GWSD_SETTING_BASE_HANDLER_H__
#define __RFX_GWSD_SETTING_BASE_HANDLER_H__
...
typedef void destroySettingHandler_t(RfxGwsdSettingBaseHandler*);

#endif /* __RFX_GWSD_SETTING_BASE_HANDLER_H__ */
