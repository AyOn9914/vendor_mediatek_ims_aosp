...
class IVTInterface : virtual public RefBase {
  public:
    ...
    virtual status_t setCameraParameters(int sim_id, int sensorCnt,
                                         sensor_info_vilte_t* sensor) = 0;
    virtual status_t setCameraParametersOnly(int sensorCnt, sensor_info_vilte_t* sensor) = 0;
    virtual status_t setCameraParametersWithSim(int sim_id, int major_sim_id, int sensorCnt,
                                                sensor_info_vilte_t* sensor) = 0;
...
class IVTNotifyCallback : virtual public RefBase {
  public:
    virtual void notifyCallback(int id, int msg, int arg1, int arg2, int arg3, const String8& obj1,
                                const String8& obj2, const sp<IGraphicBufferProducer>& obj3) = 0;
