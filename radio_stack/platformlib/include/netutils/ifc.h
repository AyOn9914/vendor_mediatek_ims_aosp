...
/// M: [2635 telematics] Internal added @{
...
extern int ifc_setInterfaceThrottle(const char *iface, int rxKbps, int txKbps);
extern int ifc_getInterfaceRxThrottle(const char *iface, int *rx);
extern int ifc_getInterfaceTxThrottle(const char *iface, int *tx);
